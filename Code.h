...
public:
    std::string dest(std::string s) {
        static std::map<std::string, std::string> destcode = {
    ...
    std::string comp(std::string s) {
        static std::map<std::string, std::string> compcode = {
            ...
            {"A|D", "0010101"}, {"!M",  "1110001"}, {"M",   "1110000"}, {"-M",  "1110011"},
            {"M+1", "1110111"}, {"M-1", "1110010"}, {"D+M", "1000010"}, {"M+D", "1000010"},
            {"D-M", "1010011"}, {"M-D", "1000111"}, {"D&M", "1000000"}, {"M&D", "1000000"},
    ...
    std::string jump(std::string s) {
        ...
        return jumpcode.find(s) != jumpcode.end() ? jumpcode[s] : "000";
    }
};
